...
| Bus WAZAA joignable depuis l'adaptateur N243 | ✅ TCP 2026-08-23T21:42+02:00 — `python src/bus_runner.py` → port **1873 OUVERT** (`[WAZAA] Bus runner READY`, async_port=1873, threads=144). Validation adaptateur N243 complet : Sprint 2 |
